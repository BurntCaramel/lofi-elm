...
var _user$project$Lofi$Content = function (a) {
	return {ctor: 'Content', _0: a};
};
var _user$project$Lofi$Flag = function (a) {
	return {ctor: 'Flag', _0: a};
};
var _user$project$Lofi$Element = function (a) {
	return {ctor: 'Element', _0: a};
};

var _user$project$Lofi_Parse$tagKeyAndValueReducer = F2(
...
var _user$project$Lofi_Parse$tagKeyValueRegex = _elm_lang$core$Regex$regex('\\B#([a-zA-Z0-9-_]+)(:\\s*([^#]*))?');
var _user$project$Lofi_Parse$nonEmptyRegex = _elm_lang$core$Regex$regex('\\S');
var _user$project$Lofi_Parse$rejectEmptyStrings = _elm_lang$core$List$filter(
	function (_p1) {
		return !A2(_elm_lang$core$Regex$contains, _user$project$Lofi_Parse$nonEmptyRegex, _p1);
	});
var _user$project$Lofi_Parse$convertToKeyPath = function (input) {
	return _user$project$Lofi_Parse$rejectEmptyStrings(
		A2(
			_elm_lang$core$String$split,
			'.',
			_elm_lang$core$String$trim(input)));
};
var _user$project$Lofi_Parse$reduceMultipleSpaces = A3(
...
var _user$project$Lofi_Parse$textsAndMentionSeriesReducer = F2(
	function (_p4, _p3) {
		var _p5 = _p4;
		var _p9 = _p5._1;
		var _p6 = _p3;
		...
		return isMention ? {
			...
			_1: A2(
				...
				{
					ctor: '::',
					_0: _user$project$Lofi_Parse$convertToKeyPath(_p9),
					_1: {ctor: '[]'}
				})
		} : {
			ctor: '_Tuple2',
			_0: A2(
				...
				{
					ctor: '::',
					_0: _user$project$Lofi_Parse$reduceMultipleSpaces(_p9),
					_1: {ctor: '[]'}
				}),
			_1: _p7
		};
	});
var _user$project$Lofi_Parse$extractTextAndMentionSeries = function (list) {
	return A3(
		_elm_lang$core$List$foldl,
		_user$project$Lofi_Parse$textsAndMentionSeriesReducer,
		{
			ctor: '_Tuple2',
			_0: {ctor: '[]'},
			_1: {ctor: '[]'}
...
var _user$project$Lofi_Parse$mentionsRegex = _elm_lang$core$Regex$regex('\\B@([a-zA-Z0-9-_]+(?:\\.[a-zA-Z0-9-_]+)*)');
var _user$project$Lofi_Parse$parseTextsAndMentions = function (input) {
	return function (_p10) {
		var _p11 = _p10;
		return {texts: _p11._0, mentions: _p11._1};
	}(
		_user$project$Lofi_Parse$extractTextAndMentionSeries(
			A3(_elm_lang$core$Regex$split, _elm_lang$core$Regex$All, _user$project$Lofi_Parse$mentionsRegex, input)));
};
var _user$project$Lofi_Parse$parseTagValue = function (input) {
	var _p12 = input;
	if (_p12.ctor === 'Nothing') {
		return _user$project$Lofi$Flag(true);
	} else {
		return _user$project$Lofi$Content(
			_user$project$Lofi_Parse$parseTextsAndMentions(_p12._0));
	}
};
var _user$project$Lofi_Parse$parseTagSubmatches = function (submatches) {
	var _p13 = submatches;
		...
		return A2(
			...
			function (key) {
				return {
					ctor: '_Tuple2',
					_0: key,
					_1: _user$project$Lofi_Parse$parseTagValue(_p13._1._1._0)
				};
			},
			_p13._0);
	} else {
...
var _user$project$Lofi_Parse$parseTag = function (input) {
	return function (matches) {
		var _p14 = matches;
		if (_p14.ctor === '::') {
			return _user$project$Lofi_Parse$parseTagSubmatches(_p14._0.submatches);
		} else {
			return _elm_lang$core$Maybe$Nothing;
		}
	}(
		A3(_elm_lang$core$Regex$find, _elm_lang$core$Regex$All, _user$project$Lofi_Parse$tagKeyValueRegex, input));
};
var _user$project$Lofi_Parse$tagsRegex = _elm_lang$core$Regex$regex('\\B#\\w+(:\\s*[^#]*)?');
var _user$project$Lofi_Parse$parseTags = function (input) {
	return A3(
		_elm_lang$core$List$foldl,
		_user$project$Lofi_Parse$tagKeyAndValueReducer,
		_elm_lang$core$Dict$empty,
		A2(
			_elm_lang$core$List$map,
			function (match) {
				return _user$project$Lofi_Parse$parseTag(match.match);
			},
			A3(_elm_lang$core$Regex$find, _elm_lang$core$Regex$All, _user$project$Lofi_Parse$tagsRegex, input)));
};
var _user$project$Lofi_Parse$parseElement = function (input) {
	var tags = _user$project$Lofi_Parse$parseTags(input);
	var _p15 = _user$project$Lofi_Parse$parseTextsAndMentions(
		_elm_lang$core$String$trim(
			A4(
				_elm_lang$core$Regex$replace,
				_elm_lang$core$Regex$All,
				_user$project$Lofi_Parse$tagsRegex,
				function (_p16) {
					return '';
				},
				input)));
	...
	return _user$project$Lofi$Element(
		{
			texts: texts,
			mentions: mentions,
			tags: tags,
...
var _user$project$LofiBootstrap4$viewLofiRaw = function (element) {
	return A2(
...
var _user$project$LofiBootstrap4$viewElementBootstrap4 = function (element) {
	...
	var _p3 = _p0._0.tags;
	var hasTagText = F2(
		function (tag, valueToMatch) {
			var _p1 = A2(_elm_lang$core$Dict$get, tag, _p3);
			if (_p1.ctor === 'Just') {
				var _p2 = _p1._0;
				if (_p2.ctor === 'Content') {
					return _elm_lang$core$Native_Utils.eq(
	...
	var hasTag = function (tag) {
		return A2(_elm_lang$core$Dict$member, tag, _p3);
	};
	if (hasTag('button')) {
		return A2(
		...
		if (hasTag('alert')) {
			var variationClass = A2(hasTagText, 'variation', 'success') ? 'alert-success' : (A2(hasTagText, 'variation', 'danger') ? 'alert-danger' : 'alert-info');
			return A2(
					...
					_0: _elm_lang$html$Html_Attributes$classList(
						{
							...
							_1: {
								ctor: '::',
								_0: {ctor: '_Tuple2', _0: variationClass, _1: true},
								_1: {ctor: '[]'}
							}
						}),
					_1: {ctor: '[]'}
...
var _user$project$LofiBootstrap4$removeFromList = F2(
	function (index, list) {
		return A2(
			...
			A2(
				...
				F2(
					function (i, item) {
						return _elm_lang$core$Native_Utils.eq(i, index) ? _elm_lang$core$Maybe$Nothing : _elm_lang$core$Maybe$Just(item);
					}),
				list));
	});
var _user$project$LofiBootstrap4$replaceInList = F3(
	function (index, replacement, list) {
		return A2(
			_elm_lang$core$List$indexedMap,
			F2(
				function (i, original) {
					return _elm_lang$core$Native_Utils.eq(i, index) ? replacement : original;
				}),
			list);
	});
var _user$project$LofiBootstrap4$update = F2(
	function (msg, model) {
		var _p5 = msg;
		switch (_p5.ctor) {
			case 'ChangeItem':
				return {
					...
					_0: _elm_lang$core$Native_Utils.update(
						model,
						{
							items: A3(_user$project$LofiBootstrap4$replaceInList, _p5._0, _p5._1, model.items)
						}),
			...
			default:
				return {
					...
					_0: _elm_lang$core$Native_Utils.update(
						model,
						{
							items: A2(_user$project$LofiBootstrap4$removeFromList, _p5._0, model.items)
						}),
					_1: _elm_lang$core$Platform_Cmd$none
				};
		}
	});
var _user$project$LofiBootstrap4$model = {
	items: {
		ctor: '::',
		_0: 'Click me #button #primary',
		_1: {ctor: '[]'}
	}
};
var _user$project$LofiBootstrap4$Model = function (a) {
	return {items: a};
};
var _user$project$LofiBootstrap4$RemoveItem = function (a) {
	return {ctor: 'RemoveItem', _0: a};
};
var _user$project$LofiBootstrap4$AddItem = {ctor: 'AddItem'};
var _user$project$LofiBootstrap4$ChangeItem = F2(
	function (a, b) {
		return {ctor: 'ChangeItem', _0: a, _1: b};
	});
var _user$project$LofiBootstrap4$viewItem = F2(
	function (index, content) {
		var element = _user$project$Lofi_Parse$parseElement(content);
		return A2(
			_elm_lang$html$Html$div,
			{
				ctor: '::',
			...
			},
			{
				...
				_1: {
					...
					_0: A2(
						...
						{
							ctor: '::',
							_0: _user$project$LofiBootstrap4$viewElementBootstrap4(element),
							_1: {ctor: '[]'}
						}),
					_1: {ctor: '[]'}
				}
...
var _user$project$LofiBootstrap4$view = function (model) {
	return A2(
		...
		},
		{
			...
			_0: A2(
				_elm_lang$html$Html$div,
				{ctor: '[]'},
				A2(_elm_lang$core$List$indexedMap, _user$project$LofiBootstrap4$viewItem, model.items)),
			_1: {
				ctor: '::',
				_0: A2(
					_elm_lang$html$Html$button,
					{
						ctor: '::',
						_0: _elm_lang$html$Html_Events$onClick(_user$project$LofiBootstrap4$AddItem),
						_1: {ctor: '[]'}
					},
					{
						ctor: '::',
...
var _user$project$LofiBootstrap4$main = _elm_lang$html$Html$program(
	{
		view: _user$project$LofiBootstrap4$view,
		update: _user$project$LofiBootstrap4$update,
		subscriptions: function (_p6) {
			return _elm_lang$core$Platform_Sub$none;
		},
		init: {ctor: '_Tuple2', _0: _user$project$LofiBootstrap4$model, _1: _elm_lang$core$Platform_Cmd$none}
	})();

var Elm = {};
Elm['LofiBootstrap4'] = Elm['LofiBootstrap4'] || {};
if (typeof _user$project$LofiBootstrap4$main !== 'undefined') {
    _user$project$LofiBootstrap4$main(Elm['LofiBootstrap4'], 'LofiBootstrap4', undefined);
}
